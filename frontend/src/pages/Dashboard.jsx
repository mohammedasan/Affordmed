    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                ...
                <input
                  type="date"
                  className="w-full px-4 py-3 rounded-lg border-0 bg-white/90 text-gray-900 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-all duration-200"
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-40 -left-40 w-60 h-60 bg-white/5 rounded-full"></div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Choose from our comprehensive range of professional bike services. 
            Each service is performed by certified technicians using premium parts.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  disabled={bookingLoading === service._id}
                >
                  {bookingLoading === service._id ? (
